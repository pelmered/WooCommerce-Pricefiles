...
(function ($) {
    ...
    $(
        function () {
            ...
            $("#wc_pricefiles_reset_address").click(
                function(e) {
            ...
            $('#woocommerce-pricefiles_options_use_cache').change(
                function(){
            ...
            $('#woocommerce-pricefiles_refresh_cache_button').click(
                function(e){
            ...
            $('#woocommerce-pricefiles_expand_disable_timeout_info').click(
                function(e){
