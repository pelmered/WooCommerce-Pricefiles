...
(function ($) {
    ...
    $(
        function () {
            ...
            $('#options_group_manufacturer').on(
                'input', '#woocommerce-pricefiles_ean_code', function() {
            ...
            $('#options_group_manufacturer').on(
                'blur', '#woocommerce-pricefiles_ean_code', function() {
            ...
            $('#woocommerce-pricefiles_manufacturer, #woocommerce-pricefiles_pricelist_cat').each(
                function() {
                    $(this).chosen();
                }
            );
